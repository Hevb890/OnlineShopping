...
export default function ProductCard({ id, name, description, price, imageUrl, refreshCart }) {
  ...
  return (
    ...
    >
      ...
      <p className="text-base font-bold text-indigo-600 mb-4">₹{price}</p>
      <button
        onClick={handleAddToCart}
        className="w-full bg-indigo-600 text-white py-2 rounded-xl hover:bg-indigo-700 transition-colors duration-200"
      >
        Add to Cart
      </button>
    </div>
