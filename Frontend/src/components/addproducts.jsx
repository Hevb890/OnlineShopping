    ...
    <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
      ...
      <form onSubmit={handleSubmit} className="space-y-5">
        ...
        <button
          ...
          className="px-4 py-2 bg-[#ed1743] py-2 px-4 rounded-lg text-white border border-gray-300 font-medium hover:bg-gray-50 hover:border-gray-400 hover:text-gray-700 transition-colors text-sm"
        >
          Add Product
        </button>
      </form>
